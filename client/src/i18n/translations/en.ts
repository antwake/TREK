const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.tagline': 'Ink our best moments.',
  ...
  'vacay.sharingHint': 'Share your vacation plan with other TalaGala users',
  'vacay.owner': 'Owner',
  'vacay.shareEmailPlaceholder': 'Email of TalaGala user',
  ...
  'vacay.inviteHint': 'Invite another TalaGala user to share a combined vacation calendar.',
